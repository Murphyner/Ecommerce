        ...
        <div className={`${isLoading ? "h-screen" : "py-5"}`}>
            ...
            <div className='flex justify-between items-center mb-10 px-8'>
                <div className='w-3/12'>
                    <input type="text" placeholder='Search for category' className='block w-full border outline-none border-gray-600 bg-gray-700 text-white placeholder-gray-400 p-2.5 text-sm rounded-lg' />
                </div>
