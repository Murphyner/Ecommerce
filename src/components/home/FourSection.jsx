                ...
                <div className='sm:py-20 xl:py-32'>
                    <div className='flex justify-end h-[30vh] sm:h-auto items-center px-8 md:px-0'>
                        <div>
                            ...
                            <button onClick={() => navigate(`/products`)} className='bg-[#DC375F] lg:px-8 lg:py-3 md:text-[1.1em] md:px-5 md:py-1 text-white py-[3px] px-[10px] text-[0.625em] sm:text-[0.75em] font-normal rounded-[25px]'>
                                Shop Now
                            </button>
                        </div>
                    </div>
